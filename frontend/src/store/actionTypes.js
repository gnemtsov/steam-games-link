...
export const R_START_INTERSECTION = 'R_START_INTERSECTION';
export const R_DO_INTERSECTION = 'R_DO_INTERSECTION';
export const R_FINISH_INTERSECTION = 'R_FINISH_INTERSECTION';
...
export const S_CALCULATE_INTERSECTION = 'S_CALCULATE_INTERSECTION';
